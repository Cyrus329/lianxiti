...
const FORCE_CLEAN_VERSION = "20260717-v38-corrected-planner";
...
const LOCAL_BACKUP_SCHEMA = "question-bank-local-backup-v38-corrected-planner";
...
function renderDashboard() {
  ...
  els.dashboardPanel.innerHTML = `
    ...
    <div class="dashboard-card backup-card ${backup.needsBackup ? "needs-backup" : ""}">
      ...
      <div class="timer-actions backup-actions">
        ...
        <button class="secondary-button" id="localBackupNowButton" type="button">导出本地备份</button>
      </div>
    </div>
  `;
  ...
  const localBackupNowButton = els.dashboardPanel.querySelector("#localBackupNowButton");
  if (localBackupNowButton) {
    localBackupNowButton.addEventListener("click", exportLocalBackup);
  }
